...
yesBtn.addEventListener("mouseover", () => {
  ...
  if (i < 10) {
    ...
    yesBtn.addEventListener("dblclick", () => {
      title.innerHTML =
        "<span style='font-size:30px;'>Noice! Let's start</span>";
      document.querySelector("#my-popup").style.display = "flex";
      document.getElementById("sign").style.display = "none";
      setTimeout(() => $loader.classList.add("loader--active"), 4000);
...
noBtn.addEventListener("dblclick", () => {
  title.innerHTML = "<span style='font-size:30px;'>Noice! Let's start</span>";
  document.querySelector("#my-popup").style.display = "flex";
  document.getElementById("sign").style.display = "none";
